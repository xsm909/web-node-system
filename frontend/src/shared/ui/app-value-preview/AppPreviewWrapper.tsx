...
const TYPE_STYLES: Record<string, string> = {
    ...
    array: 'text-purple-600/90 bg-purple-500/5 border-purple-600/50 shadow-purple-500/5',
    object: 'text-purple-600/90 bg-purple-500/5 border-purple-600/50 shadow-purple-500/5',
