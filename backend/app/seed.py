...
def seed():
    ...
    try:
        ...
        nodes_data = [
            ...
            {
                "id": "b52cc86f-058d-4597-9e97-bfb362de5f88",
                "name": "Response processing",
                "version": "1.0",
                "description": "",
                "code": "class NodeParameters:\n    agent_Hint_key: str = \"\" # @table-agent_hints->key,agent_hints->key\n    responce_schema_key: str = \"\"  # @table-schemas->key,schemas->key\n    ai_model: str\n    \ndef run(inputs, params):\n    client_id = common.get_active_client()['id']\n    if not client_id:\n        print ('Set client')\n        return {}\n\n    end_date = datetime.now()\n    start_date = end_date - timedelta(days=10)\n\n    print (client_id, \"From: \", start_date, \" to \", end_date)\n    \n    responses = response_data.get_responses_by_period_and_category(\n        reference_id=client_id,\n        category_pattern=\"Recommendation|%\",\n        start_date=start_date,\n        end_date=end_date\n    )\n    \n    for response in responses:\n        print (response['id'])\n    \n    return {}",
                "input_schema": {},
                "output_schema": {},
                "parameters": [
                    {
                    ...
                    {
                        "name": "responce_schema_key",
                        "type": "string",
                        "label": "Responce Schema Key",
                        "default": "",
                        "options_source": {
                            "table": "schemas",
                            "value_field": "key",
            ...
            {
                "id": "cbcdc477-0c80-4c26-bb1d-4f63c8842980",
                "name": "Generate prompt recomendation",
                "version": "1.0",
                "description": "",
                "code": "def run(inputs, params):\n    result_schema = \"common-prompts\"\n    client_id = common.get_active_client()\n    \n\n    model = \"gemini-pro-latest\"\n    provider = common.GetAIByModel (model)\n    agent_hint_template = agent.get_agent_hint_by_key (\"prompt-recomendation\")\n    brand_data_array = meta.get_client_metadata_by_schema (client_id['id'], \"brand\")\n\n    pairs_category_persona = []\n\n    for brand_data in brand_data_array:\n        for persona_id in brand_data['persona']:\n            for category in brand_data['category']:\n                category_data = meta.get_metadata_by_id (category)\n                if persona_id in category_data['persona']:\n                   pairs_category_persona.append ((persona_id, category, brand_data['__id__']))\n\n\n    \n    for persona_id, category_id, brand_id in pairs_category_persona:\n\n        persona_data = meta.get_metadata_by_id (persona_id)\n        category_data = meta.get_metadata_by_id (category_id)\n        brand_data = meta.get_metadata_by_id (brand_id)\n\n        json_data = '{\"persona\": ' + json.dumps (persona_data) + ', \"category\": ' + json.dumps (category_data) + ', \"brand\": '+ json.dumps (brand_data) + '}'\n        agent_hint = common.fill_template (agent_hint_template, json.loads(json_data))\n        \n        agent_task = \"\"\n\n        print (agent_hint)\n        \n        \n        result = agent.run(\n            model=model,\n            tools=[\"google_search\"], # \u0421\u043f\u0438\u0441\u043e\u043a \u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u0445 \u0438\u043d\u0441\u0442\u0440\u0443\u043c\u0435\u043d\u0442\u043e\u0432\n            hint=agent_hint,\n            task=agent_task,\n            schema_key = result_schema,\n            iteration_limit=5\n        )\n        print (result)\n        prompts.add_prompt (brand_data['__id__'], \"metadata\", \"Recommendation\", result, result_schema, client_id['id'])\n\n    return {}\n        \n",
                "input_schema": {},
                "output_schema": {},
                "parameters": [],
                "category": "AI|Metadata",
            ...
            {
                "id": "7603df9e-1277-4b1c-9e29-e78381171ffc",
                "name": "Check responses for error",
                "version": "1.0",
            ...
            },
            {
                ...
                "version": "1.0",
                "description": "",
                "code": "def run(inputs, params):\n    \n    \n    provider = \"gemini-pro-latest\"\n    result = agent.run(\n        model=provider,       \n        tools=[\"google_search\"],\n        hint=\"\",\n        task=\"Who is Cuisine Solutions so and what do they make?\",\n        schema_key = \"\",\n        iteration_limit=5\n    )\n\n    print (result)\n    \n    \n    return result",
                "input_schema": {},
                "output_schema": {},
                "parameters": [],
                "category": "temp|1",
            ...
            {
                "id": "54be731d-5655-43b9-900b-5b3881836c68",
                "name": "Set active client",
                "version": "1.0",
                "description": "",
                "code": "class NodeParameters:\n    client_id: str # @table-users->id,users->username\ndef run(inputs, params):\n    data = libs.get_runtime_data()\n\n    if params.Name not in data or params.Update:\n        data['_active_client_id'] = params.client_id\n        libs.update_runtime_data(data)\n\n    return",
                "input_schema": {},
                "output_schema": {},
                "parameters": [
                    {
